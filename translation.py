...
START_MESSAGE = '''**Hello, {}
I Am tamizhmasters.com, Bulk Link Converter. I Can Convert Links Directly From Your tamizhmasters.com Account,
...
HELP_MESSAGE = '''**Hello, {}
I Am tamizhmasters, Bulk Link Converter Bot. I Can Convert Links Directly From Your tamizhmasters Account,**
    
1. Go To 👉 https://tamizhmasters.com/member/tools/api  
2. Than **Copy API** Key
3. Than Type **/api** than give a **single space** and than **paste** your **API** Key (**see example** to understand more...)
...
• I can **Convert any** links or posts to your **tamizhmasters** link / post. (Button Links Posts, Hidden links/Hyperlinks All Are Supported)
...
Ex: https://t.me/tamizhmasters | tamizhmasters"""
...
USER_ABOUT_MESSAGE = """
- Website: [{base_site}](https://tamizhmasters/ref/)
...
Get API From [{base_site}](https://tamizhmasters/ref/rngharman)
...
USERNAME_TEXT = """**Hello Harman, I am tamizhmasters.com, Bulk Link Converter Bot From Linked tamizhmasters.com Account,**

**🌟 Type** /channel (channel link or username)

**example:**
/channel @tamizhmasters
Or
/channel https://t.me/tamizhmasters
